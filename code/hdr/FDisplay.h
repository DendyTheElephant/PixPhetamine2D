...
namespace PixPhetamine2D {
	...
	namespace Display {
		...
		/// \brief		Will open the SDL Window (UI) and initialize OpenGL (PixPhetamine2D context) in it.
		...
		/// \brief		Will close and free the SDL Window (UI) and OpenGL (PixPhetamine2D context).
